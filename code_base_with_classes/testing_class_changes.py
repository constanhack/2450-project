...
from laod_store_ops import Load, Store
...
while mem.get_pc() < mem.mem_size:
    ...
    if mem.get_mem_value(pc_location) == '+0000':
        mem.increment_pc()
        continue
    ...
    sign = mem.get_mem_value(pc_location)[:1]
    if sign == '+':
        branched = Check_for_Operation(mem.get_mem_value(pc_location)[1:5])
